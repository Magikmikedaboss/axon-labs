...
function Pill(props: { text: string }) {
  return (
    <div className="rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white/70 hover:bg-white/10 transition">
      {props.text}
    </div>
  );
}
    ...
    <SiteShell>
      ...
      <div className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 wrap pt-20 pb-16 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-black/40 backdrop-blur px-4 py-2 text-xs text-white/80 mb-6">
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-white/70 leading-relaxed mb-4">
                Biohacking is the practice of <strong className="text-white">intentionally improving how the body functions</strong>{" "}
          ...
          <Section title="What Biohacking Is Not">
            ...
            <div className="grid sm:grid-cols-2 gap-3 mb-4">
              {[
                ...
                <div key={i} className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white/70">
                  • {item}
                </div>
              ))}
            </div>
          ...
          <div className="relative rounded-3xl overflow-hidden border border-white/10">
            ...
            <div className="relative z-10 p-8 sm:p-12">
              ...
              <p className="text-white/80 text-lg leading-relaxed mb-6">
                The human body adapts based on <strong className="text-white">signals</strong>, not products.
              </p>
              ...
              <div className="rounded-2xl border border-white/20 bg-black/40 backdrop-blur p-6">
          ...
          <Section title="Levels of Biohacking (Context Matters)">
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/0 p-6">
                <div className="text-sm font-semibold text-white mb-3">Foundational Biohacking</div>
              ...
              <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/0 p-6">
                <div className="text-sm font-semibold text-white mb-3">Advanced Biohacking</div>
                <p className="text-sm text-white/70 leading-relaxed mb-4">
                  This includes:
                </p>
                <ul className="space-y-2 text-sm text-white/70">
          ...
          <Section title="Where Peptides Fit (Research Context Only)">
            <p className="text-white/70 leading-relaxed mb-4">
              ...
              <strong className="text-white">cellular signaling</strong>.
            </p>
            <div className="rounded-2xl border border-white/10 bg-black/25 p-6 mb-4">
              <div className="text-sm font-semibold text-white mb-3">Important Distinctions:</div>
              <ul className="space-y-2 text-sm text-white/70">
          ...
          <Section title="Why Restraint Matters">
            ...
            <p className="text-white/70 leading-relaxed">
              ...
              <strong className="text-white"> Stopping is a valid outcome.</strong>
            </p>
          </Section>
          ...
          <Section title="How Axon Labs Approaches Biohacking">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                <div className="text-sm font-semibold text-white mb-3">We Publish</div>
                <ul className="space-y-2 text-sm text-white/70">
                  <li>• Context</li>
                  <li>• Definitions</li>
                  <li>• Standards</li>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                <div className="text-sm font-semibold text-white mb-3">We Do Not Publish</div>
                <ul className="space-y-2 text-sm text-white/70">
