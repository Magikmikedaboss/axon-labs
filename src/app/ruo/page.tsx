  ...
  return (
    <SiteShell>
      <div className="wrap pt-10 sm:pt-14 pb-14">
        ...
        {/* Compliance banner */}
        <div className="border border-slate-300 bg-slate-50 p-4 sm:p-6 text-xs text-slate-600 leading-relaxed">
          <strong className="text-slate-900">Compliance notice:</strong> Axon Labs publishes educational content
          and provides materials intended for <strong className="text-slate-900">Research Use Only (RUO)</strong>.
          RUO materials are <strong className="text-slate-900">not for human or veterinary use</strong>. We do not
        ...
        <div className="mt-10 space-y-6">
          ...
          <Section title="Documentation and traceability (what matters in RUO)">
            ...
            <div className="mt-4 border border-slate-300 bg-slate-50 p-4 sm:p-5 text-xs text-slate-600 leading-relaxed">
              <strong className="text-slate-900">Note:</strong> Documentation is provided for transparency and
          ...
          <Section title="Purchasing and responsibility (if materials are offered)">
            ...
            <div className="mt-4 border border-slate-300 bg-slate-50 p-4 sm:p-6">
              <div className="text-sm font-semibold text-slate-900">Our posture is simple</div>
          ...
          {/* Bottom CTAs */}
          <div className="border border-slate-300 bg-slate-50 p-4 sm:p-7">
            <div className="text-sm font-semibold text-slate-900">Where to go next</div>
          ...
          {/* Final compliance */}
          <div className="border border-slate-300 bg-slate-50 p-4 sm:p-6 text-xs text-slate-600 leading-relaxed">
            <strong className="text-slate-900">Final reminder:</strong> Nothing on Axon Labs is medical advice or
...
function Section(props: { title: string; children: React.ReactNode }) {
  return (
    <section className="border border-slate-300 bg-slate-50 p-3 sm:p-5">
      <div className="text-xs font-semibold tracking-wider uppercase text-blue-600">RUO</div>
      <h2 className="mt-2 text-lg sm:text-xl font-semibold text-slate-900">{props.title}</h2>
...
function Card(props: { title: string; children: React.ReactNode }) {
  return (
    <div className="border border-slate-300 bg-slate-50 p-3 sm:p-5">
