        ...
        <div className="surface p-7 sm:p-10">
          ...
          <div className="mt-10 space-y-6">
            ...
            <Section title="Documentation and traceability (what matters in RUO)">
              ...
              <div className="mt-4 border border-slate-300 bg-slate-50 p-5 text-xs text-slate-600 leading-relaxed">
            ...
            <Section title="Purchasing and responsibility (if materials are offered)">
              ...
              <div className="mt-4 border border-slate-300 bg-slate-50 p-6">
            ...
            {/* Bottom CTAs */}
            <div className="border border-slate-300 bg-slate-50 p-7">
...
function Section(props: { title: string; children: React.ReactNode }) {
  return (
    <section className="border border-slate-300 bg-slate-50 p-7">
      ...
      <h2 className="mt-2 text-xl font-semibold text-slate-900">{props.title}</h2>
